Contributing to Curiumn Core
============================

The Curiumn Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Curiumn Core project, and is not to be
confused with overall Curiumn Network Protocol consensus changes.

Whether a pull request is merged into Curiumn Core rests with the project merge
...
Patches that change Curiumn consensus rules are considerably more involved than
...
Where a patch set proposes to change the Curiumn consensus, it must have been
...
The project leader is the release manager for each Curiumn Core release.

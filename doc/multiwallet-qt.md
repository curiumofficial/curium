...
In order to support loading of multiple wallets in curiumn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is curiumn.cpp.
...
Changes to curiumn.cpp
----------------------
curiumn.cpp is the entry point into curiumn-qt, and as such, will require some minor modifications to provide hooks for

...
* WebSocket: [https://github.com/curiumnproject/insight-api-curiumn#web-socket-api](https://github.com/curiumnproject/insight-api-curiumn#web-socket-api) 
* API: [https://github.com/curiumnproject/insight-api-curiumn#swifttx-transactions](https://github.com/curiumnproject/insight-api-curiumn#swifttx-transactions) 
...
By default, the Curiumn Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Curiumn Core daemon:

...
The key and certificate is in a separate, passcruase-protected keychain file that is
...
The key and certificate were exported into a separate, passcruase-protected PKCS#12 file, and
...
install a keylogger to get the passcruase that protects them.

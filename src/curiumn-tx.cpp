...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Curiumn Core curiumn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  curiumn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded curiumn transaction") + "\n" +
                               "  curiumn-tx [options] -create [commands]   " + _("Create hex-encoded curiumn transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded curiumn transaction

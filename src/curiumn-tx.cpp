...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Curium Core curiumn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  curiumn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded curium transaction") + "\n" +
                               "  curiumn-tx [options] -create [commands]   " + _("Create hex-encoded curium transaction") + "\n" +
                               "\n";

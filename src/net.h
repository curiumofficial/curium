...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemacuriumnGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemacuriumnGrant grantOutbound;

    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Curiumn and make it unusable. To
...
bool CObfuscationPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeCuriumnAmount * COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckObfuScationPool()
{
    ...
    RenameThread("curiumn-obfuscation");

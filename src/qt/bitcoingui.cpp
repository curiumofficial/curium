                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Curiumn Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Curiumn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and curiumn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Curiumn Core"), this);
    aboutAction->setStatusTip(tr("Show information about Curiumn Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Curiumn"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Curiumn addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Curiumn addresses"));
    ...
    openAction->setStatusTip(tr("Open a Curiumn: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Curiumn Core help message to get a list with possible Curiumn command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Curiumn Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Curiumn network", "", count));
}
...
{
    QString strTitle = tr("Curiumn Core"); // default title

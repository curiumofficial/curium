...
/** Utility functions used by the Curiumn Qt UI.
 */
namespace GUIUtil
{
...
// Render Curiumn addresses in monospace font
...
// Parse "curiumn:" URI into recipient object, return true on successful parsing

...
void PrivacyDialog::on_pushButtonMintzCRU_clicked()
{
    ...
    if (encStatus == walletModel->Locked) {
        ...
        if (!ctx.isValid()) {
            ...
            ui->TEMintStatus->setPlainText(tr("Error: Your wallet is locked. Please enter the wallet passcruase first."));
            return;
        }
    }
...
void PrivacyDialog::sendzCRU()
{
    ...
    if (!ZCruControlDialog::listSelectedMints.empty()) {
        vMintsSelected = ZCruControlDialog::GetSelectedMints();
    }
    ...
    ZCruControlDialog::listSelectedMints.clear();

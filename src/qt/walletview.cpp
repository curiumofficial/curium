...
void WalletView::encryptWallet(bool status)
{
    if (!walletModel)
        return;
    AskPasscruaseDialog dlg(status ? AskPasscruaseDialog::Encrypt : AskPasscruaseDialog::Decrypt, this, walletModel);
    dlg.exec();
...
void WalletView::changePasscruase()
{
    AskPasscruaseDialog dlg(AskPasscruaseDialog::ChangePass, this, walletModel);
    dlg.exec();
}
...
void WalletView::unlockWallet()
{
    ...
    if (walletModel->getEncryptionStatus() == WalletModel::Locked || walletModel->getEncryptionStatus() == WalletModel::UnlockedForAnonymizationOnly) {
        AskPasscruaseDialog dlg(AskPasscruaseDialog::UnlockAnonymize, this, walletModel);
        dlg.exec();
    }
}

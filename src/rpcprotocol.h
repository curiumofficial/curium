...
enum RPCErrorCode {
    ...
    RPC_WALLET_UNLOCK_NEEDED = -13,        //! Enter the wallet passcruase with walletpasscruase first
    RPC_WALLET_PASSCRUASE_INCORRECT = -14, //! The wallet passcruase entered was incorrect

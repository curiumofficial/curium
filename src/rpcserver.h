...
extern std::string HelpRequiringPasscruase();
...
extern json_spirit::Value walletpasscruase(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value walletpasscruasechange(const json_spirit::Array& params, bool fHelp);
